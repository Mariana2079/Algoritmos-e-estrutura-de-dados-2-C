...
//Exercicio feito em sala de aula dia 12/05
...
//exercicio feito em sala da altura negra 
int altura_negra(NodeVP *tree){ //VP = vermelha e preta
    int h = 1;
    NodeVP *aux = tree;
    
    while(aux != NULL){
        h += (aux->color == 1);
        aux = aux->left; //poderia receber rigth
    }
    return h;
}

// exercicio feito em sala contar nodes vermelhos
